...
- Write about daily routines and activities
- Describe habits and weekly schedules
- Write a simple narrative about a past event (weekend, trip)
- Write about preferences and hobbies
- Fill in forms with personal information and schedules
...
- Your morning routine (se lever, se laver, prendre le petit-déjeuner)
- Your activities during the day
- What you do in the evening

**Useful verbs:**
- Je me lève à...
- Je prends le petit-déjeuner à...
- Je travaille de... à...
- Le soir, je...
- Je me couche à...

**Example start:**
> "Le matin, je me lève à 7h30. Je me lave et je m'habille. Ensuite, je prends mon petit-déjeuner..."
...
- When you do groceries or chores

**Useful expressions:**
- Le lundi, je...
- Du mardi au jeudi, je...
- Le week-end, je...
- Tous les jours, je...
- Deux fois par semaine, je...

**Structure:**
1. Introduction: "Ma semaine est assez..."
2. Working days activities
...
**Use Passé Composé to describe what you did.**
...
**Verbs with AVOIR:**
- j'ai mangé, j'ai fait, j'ai regardé, j'ai visité
...
- What you prefer (using comparatives)
- What you never do
- Your favorite activities in Belgium
...
**Example:**
> "J'aime faire du vélo le week-end. Je préfère les parcs à la ville. Je ne fais jamais de jogging parce que je n'aime pas courir..."
...
- [ ] My text answers the question/topic
- [ ] My ideas are simple but clear

### Grammar
- [ ] I used the correct verb tenses (présent, passé composé)
- [ ] I used reflexive verbs correctly (me/te/se)
- [ ] Verbs agree with subjects
- [ ] I used the correct auxiliary (avoir/être) in passé composé

### Vocabulary
- [ ] I used time expressions (le matin, le soir, à...h)
- [ ] I used frequency words (tous les jours, souvent, jamais)
- [ ] Words are appropriate for A1.2 level

### Structure
- [ ] Sentences are simple and short
- [ ] I used connectors (et, mais, puis, ensuite)
- [ ] Text has a beginning and an end
...
- [ ] I can write about past events (last weekend)
- [ ] I can write about my hobbies and preferences
- [ ] I can invite someone to do an activity
- [ ] I feel confident with A1.2 writing
...
- **Common Belgian expressions**:
  - "Chouette!" (Nice!/Cool!)
  - "Un pain" (a loaf of bread, not "du pain")
  - "Tantôt" (later/in a bit)
...
2. Try to identify and correct your own mistakes
3. Compare with example texts from previous lessons
4. Move on to **Leçon 18: Compréhension Orale A1.2**
...
> Practice A1.2 listening skills!
